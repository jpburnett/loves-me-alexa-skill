...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech = _(data.HELP_MSG).format(item)
...
class FallbackIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        HELP_MSG = _(data.HELP_MSG).format(item)
        help_reprompt = _(data.HELP_REPROMPT).format(item)

        # Format the speech output
        speech = _(data.FALLBACK_MSG).format(
            _(data.SKILL_NAME)) + HELP_MSG
        reprompt = _(data.FALLBACK_MSG).format(
...
class YesIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if prev_intent == "LaunchIntent":
            speech = data.HELP_MSG
            reprompt = data.FALLBACK_MSG
